...
@section('title', 'Tambah Data Pesantren Terdekat')
@section('page-title', 'Tambah Data Pesantren Terdekat')
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action='/pesantren-terdekat'>
                @csrf
                <div class="form-group">
                    <label for="no_statistik">No Statistik</label>
                    <input type="text" value="{{ old('no_statistik') }}" name="no_statistik"
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="{{ old('nama_lembaga') }}"
